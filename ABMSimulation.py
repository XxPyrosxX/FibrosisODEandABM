...
class ABMSimulation:
    ...
    def updateNetworkState(self, results_dict):
        ...
        latentTGFB_ABM = odeint(self.ode_system_latentTGFB, initial_latentTGFBABM, t_latentTGFB_ABM,
        ...
        IL1b_ABM = odeint(self.ode_system_IL1B, initial_IL1B, t_IL1B, args=(kgen, kdeg))[-1][0]
        ...
        IL6_ABM = odeint(self.ode_system_IL6, initial_IL6, t_IL6, args=(kgen, ksec, IL6net, kdeg))[-1][0]
        ...
        TNFA_ABM = odeint(self.ode_system_TNFA, initial_TNFA, t_TNFA, args=(kgen, kdeg))[-1][0]
        ...
        Collagen_ABM = odeint(self.ode_system_Collagen, initial_Collagen, t_Collagen,
